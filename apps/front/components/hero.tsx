const Hero = () => {
  return (
    <div className="bg-linear-to-br from-sky-500 to-indigo-500 text-white pt-16">
      <div className="container justify-center mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
        {/* Left col */}
        <div className="flex flex-col w-full justify-center items-start md:w-1/2 lg:w-2/5 text-center md:text-left">
          <div className="flex flex-col items-center md:items-start">
            <p className="capitalize tracking-wide w-full">
              Explore insights , tutorials, and stories for curious minds like
              yours
            </p>
            <h2 className="my-5 flex items-center text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              Welcome To Blog
            </h2>
        ...
        {/* right col */}
        <div className="w-full flex justify-center text-center py-7 md:w-1/2 lg:w-3/5">
          <img
            src="/hero.png"
            alt="hero section"
